        ...
        <header className="sticky top-0 z-50 border-b border-green-100 bg-white/95 backdrop-blur-xl elevation-1">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
            ...
            <nav className="flex items-center gap-4 sm:gap-6 text-sm">
              <a href="/my-reservations" className="flex items-center gap-1.5 font-medium text-green-700 bg-green-50 hover:bg-green-100 px-3 py-1.5 rounded-lg border border-green-200 transition-colors">
